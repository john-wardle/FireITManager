...
This directory contains the planning, architecture, design, and operating notes for
FireIT Manager.
...
- [Developer Guide](08_Developer_Guide.md)
...
- [ADR-002: Camp Canvas](decisions/ADR-002-Camp-Canvas.md)
- [ADR-003: Data Storage](decisions/ADR-003-Data-Storage.md)

## Feature Specifications

- [Incident Specification](../specs/Incident.spec.md)
- [Inventory Specification](../specs/Inventory.spec.md)
- [Network Specification](../specs/Network.spec.md)
- [Canvas Specification](../specs/Canvas.spec.md)
- [Reports Specification](../specs/Reports.spec.md)

## Diagrams

Draw.io source diagrams are stored in [diagrams](diagrams/).
